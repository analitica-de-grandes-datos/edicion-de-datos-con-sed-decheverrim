...
#
sed "s/\([0-9]\)\/\([0-9]\)\/20\([0-9][0-9]\)/0\1\/0\2\/\3/g" data.csv | sed "s/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g" | sed "s/;;/;\\\N;/g" | tr ";" "," | sed "s/\([0-9][0-9][0-9]\),\([0-9]\)/\1.\2/g" | sed "s/n/N/g" | sed "s/,N/,\\\N/g" | sed "s/,\\\N,\\\N,/,\\\N,\\\N,\\\N/g" | sed "s/,C,\\\N,/,C,\\\N,\\\N/g"